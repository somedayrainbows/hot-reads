...
RSpec.feature 'as a user' do
  scenario 'i can see the top ten most-read links' do
    ...
    within(.'hot links') do
      ...
      expect(page).to have_content('2: http://tripadvisor.com')
      expect(page).to have_content('3: http://travel.com')
      expect(page).to have_content('4: http://airbnb.com')
      expect(page).to have_content('5: http://bofa.com')
      expect(page).to have_content('6: http:/united.com')
      expect(page).to have_content('7: http://reddit.com')
      expect(page).to have_content('8: http://gmail.com')
      expect(page).to have_content('9: http://twitter.com')
      expect(page).to have_content('10: http://apple.com')
